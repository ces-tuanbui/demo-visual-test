...
test(`Screenshot for https://www.veracode.com/blog/2007/07/backdoor-detection-in-the-news`, async ({ page }) => {
  const url = "https://www.veracode.com/blog/2007/07/backdoor-detection-in-the-news";
